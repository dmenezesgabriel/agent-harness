...
9. Apply design principles selectively — read [design-rules.md](references/design-rules.md) when a design decision arises. When implementing a named pattern (Strategy, Builder, Adapter, etc.), consult [design-patterns.md](references/design-patterns.md) for its structure and watch-outs.
