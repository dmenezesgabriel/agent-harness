...
def test_artifact_set_rejects_non_string_content() -> None:
    # Arrange
...
def test_artifact_set_matches_files_by_glob() -> None:
    # Arrange
...
def test_judge_verdict_rejects_score_outside_unit_interval() -> None:
    # Arrange / Act / Assert
    with pytest.raises(ValidationError):
        JudgeVerdict(
            rubric_id="palette",
