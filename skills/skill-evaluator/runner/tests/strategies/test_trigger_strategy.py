...
class FakeTriggerEvaluator:
    ...
    def evaluate(self, _skill_name: str, _evals_dir: Path, _classifier: object) -> TriggerReport:
        return self._report
...
def test_trigger_strategy_mode_is_trigger() -> None:
...
def test_trigger_strategy_returns_trigger_report(tmp_path: Path) -> None:
