@dataviz @generated
Feature: dataviz generated skill output validation
  Chart code produced by the dataviz skill on a real invocation must follow
  all design rules. These scenarios run only in invoke mode against generated output.
  ...
  Scenario: Generated chart follows all structural rules
